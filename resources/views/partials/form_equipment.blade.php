        ...
        <div class="form-group col-md-6">
            <div class="form-group">
                ...
                <select name="equipment" id="equipment"
                    class="form-control @error('equipment') is-invalid @enderror select2bs4NE" style="width: 100%;">
        ...
        <div class="form-group text-center justify-content-center align-self-center col-md-6">
            ...
            <div>
                <div class="icheck-danger icheck-inline">
                    <input class="checkbox" {{ $usr->partner->formula != true ? 'disabled' : '' }}
                        onchange="unchecked2_3()" type="checkbox" value=1 name="formula" id="formula">
                    <label for="formula">
                        ECO
                    </label>
                </div>
                <div class="icheck-danger icheck-inline ">
                    <input class="checkbox" checked onchange="unchecked1_3()" type="checkbox" value=2 name="formula"
                        id="formula2">
                    <label for="formula2">
                        STANDARD
                    </label>
                </div>
                <div class="icheck-danger icheck-inline @error('formula') is-invalid @enderror">
                    <input class="checkbox" {{ $usr->partner->formula != true ? 'disabled' : '' }}
                        onchange="unchecked1_2()" type="checkbox" value=3 name="formula" id="formula3">
                    <label for="formula3">
                        PREMIUM
...
=======
        ...
        <div class="form-group col-md-4">
            <div class="form-group">
                <label>Marque</label>
                <select name="mark" id="mark" class="form-control  @error('mark') is-invalid @enderror select2bs4NE"
                    style="width: 100%;">
        ...
        <div class="form-group col-md-4">
            <div class="form-group">
                <label>Modèle</label>
                <select name="model" id="model" class="form-control @error('model') is-invalid @enderror select2bs4NE"
                    style="width: 100%;">
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control @error('numberIMEI') is-invalid @enderror" name="numberIMEI"
                    id="numberIMEI" value="" placeholder="Saisir le numéro identifiant (IMEI)" required
                    autocomplete="numberIMEI">
           @error('numberIMEI')
                <span class="invalid-tooltip" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" id="price"
                    value="" placeholder="Saisir le prix d'achat" required autocomplete="price">
            </div>
            @error('price')
                <span class="invalid-tooltip" role="alert">
                    <strong>{{ $message }}</strong>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="input-group">
                ...
                echo "<input type='text' class='form-control @error(' date_subscription') is-invalid @enderror'
                    name='date_subscription' id='date_subscription' value=$date style='color: red' readonly />";
                ?>
        ...
        <div class="form-group col-md-3">
            ...
            <div class="input-group">
                ...
                [$annee, $mois, $jour] = sscanf($madate, '%d-%d-%d');
                $annee += 1;
                if (strlen($mois) === 1) {
                $mois = '0' . $mois;
                } else {
                ...
                echo "<input type='text' class='form-control' name='subscription_enddate' id='subscription_enddate'
                    value=$subscription_enddate style='color: red' readonly />";
                ?>
...
>>>>>>> 794290092a8c7746e68fd4b89fc0e3a33981e7bb
                ...
                <label style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">Prime à payer :
                </label>
