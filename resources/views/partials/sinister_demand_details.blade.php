<p class="lead mb-0">TRAITEMENT DE DEMANDE  |  
    <button class="btn btn-sm btn-flat btn-outline-secondary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
        <H8><strong>SOUSCRIPTION N°</strong><strong style="color: brown">{{$sinister->subscription->code}}</strong></H6>
    </button>
</p>
