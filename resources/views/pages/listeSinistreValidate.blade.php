                        ...
                        <div class="tab-content" id="custom-content-above-tabContent">
                            <div class="tab-pane fade show active" id="custom-content-above-history" role="tabpanel" aria-labelledby="custom-content-above-history-tab">
                                <div class="tab-custom-content">
                                    <p class="lead mb-0">Sinistres validés
                            ...
                            @foreach ($liste as $item)
                                    <tbody>
                                        ...
                                        <td>
                                            <center>
                                            <a href="{{route('sinister.bon',['subscription' => $subscription->id])}}"  class="btn btn-info btn-sm">
                                                <i class="fas fa-print">IMPRIMER BON</i>
                                            </a>
                                            </center>
                                        </td>
