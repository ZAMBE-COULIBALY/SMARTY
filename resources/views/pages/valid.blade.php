                    ...
                    <div class="card card-primary  shadow-sm ">
                        <div class="card-header p-0 pt-1 " style="background-color:#120d74; ">
                            <ul class="nav nav-tabs" id="custom-content-above-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="custom-content-above-history-tab" data-toggle="pill" href="#custom-content-above-history" role="tab" aria-controls="custom-content-above-history" aria-selected="true">VALIDATION DE SINISTRE</a>
                                    </li>
                            </ul>
                        </div>
                                ...
                                <div class="tab-content" id="custom-content-above-tabContent">
                                    <div class="tab-pane fade show active" id="custom-content-above-history" role="tabpanel" aria-labelledby="custom-content-above-history-tab">
                                        <div class="tab-custom-content">
                                            <p class="lead mb-0">VALIDATION SINISTRE</p>
                                                        <hr>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="row col-md 4">
                                                <form method="POST" action="{{ route('sinister.valid',['subscription' => $subscription->id]) }}" >
                                                    @csrf
                                                    ...
                                                    <div class="form-group col-md-12 " style="text-align: right; ">
                                                        <hr>
                                                        <button type="submit" class="btn btn-primary" style="width: 200px"><b>VALIDER</b> </button>
                                                    </div>
                                                </form>
                                            </div>
